...
function Environment(t::Int, m::Int, n::Int, a::Int, j::Int, h::Matrix{Float64}, d::D, I::Matrix{Float64}) where {D<:Demand}
    return Environment(t, m, n, h, a .* ones(m, t, n, n), j .* ones(m, m, t, n, n), d, I)
end
